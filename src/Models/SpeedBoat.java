...
public class SpeedBoat extends Ship implements Serializable {
    ...
    public SpeedBoat(String name, String manufacturer, Date baptismDate, Date lastInspection, Date nextInspection, Date lastMaintenance, Date nextMaintenance, double lengthInMeters, double weightInTons, int maxSpeedKnots, Operation[] history, int numberOfLifeVests) {
