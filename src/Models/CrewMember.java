...
public class CrewMember implements Serializable {
    ...
    private final String name; // Crew Member's Name
    private final Patent patent; // Crew Member's Patent
    private final Date dateOfBirth; // Crew Member's Date of Birth
